...
class lov (models.Model):
    ...
    os_amount = fields.Monetary(string='OS Amount',index=True)
    od_amount = fields.Monetary(string='OD Amount',index=True)
    write_off_amt = fields.Monetary(string='Write off Amt',index=True)
